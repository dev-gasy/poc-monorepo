...
| Very private    | \_\_snake_case       | `__[action_prefix]_[entity]`         | `__hash_password()`                         |
...
.user-card {
  ...
  &__avatar {
    // Attribute Suffix: avatar
    width: 48px;
  }

  &__user-name {
    // Attribute Suffix: user-name
    color: $primary-color;
  }

  &__order-count {
    // Attribute Suffix: order-count
    font-weight: bold;
  }

  &--active {
    // Status Modifier: active
